        ...
        <div class="row justify-content-center align-items-stretch flex_event owl-carousel owl-theme" id="eventCarousel">
                ...
                <div class="events_flex_card">
                        <a href="/events.php" class="featured-card featured-card-hover event">
                            ...
                            <div class="featured-card-body">
                                ...
                                <h3 class="featured-title">Racing Event</h3>
                                <div class="featured-text">
                                        <div class="event-loc d-flex justify-content-start align-items-center mb-3">
                                       <span> <i class="icofont-location-pin"></i></span>
                                       <span>Raipur,India</span>
                                        <img data-src="./assets/img/india.png" alt="UAE" class="event-flag" uk-img="" src="./assets/img/india.png">
                                        </div>
                                        <button class="btn reg-btn s-btn" href="javascript:void(0);">Register</button>
                                </div>
                            </div>
                        </a>
                </div>
                ...
                <div class="events_flex_card">
                        <a href="/events.php" class="featured-card featured-card-hover event">
                            ...
                            <div class="featured-card-body">
                                <span class="date">01.01.2022</span>
                                <h3 class="featured-title">Football Event</h3>
                                <div class="featured-text">
                                        <div class="event-loc d-flex justify-content-start align-items-center mb-3">
                                       <span> <i class="icofont-location-pin"></i></span>
                                       <span>Raipur,India</span>
                                        ...
                                        <button class="btn reg-btn d-btn" href="javascript:void(0);">Sold Out</button>
                                </div>
                            </div>
                        </a>
                </div>
                ...
                <div class="events_flex_card">
                        <a href="/events.php" class="featured-card featured-card-hover event">
                            ...
                            <div class="featured-card-body">
                                <span class="date">01.01.2022</span>
                                <h3 class="featured-title">Swimming Event</h3>
                                <div class="featured-text">
                                        <div class="event-loc d-flex justify-content-start align-items-center mb-3">
                                       <span> <i class="icofont-location-pin"></i></span>
                                       <span>Raipur,India</span>
                ...
                <div class="events_flex_card">
                        <a href="/events.php" class="featured-card featured-card-hover event">
                            ...
                            <div class="featured-card-body">
                                <span class="date">01.01.2022</span>
                                <h3 class="featured-title">Chess Event</h3>
                                <div class="featured-text">
                                        <div class="event-loc d-flex justify-content-start align-items-center mb-3">
                                       <span> <i class="icofont-location-pin"></i></span>
                                       <span>Raipur,India</span>
